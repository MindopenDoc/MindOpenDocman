...
$(document).ready(function () {
    ...
    if (AlreadyselectedDepartment.length > 0) {
        AlreadyselectedDepartment.forEach(element => {
            ...
            $.get(`Controller\\permissionsRelated\\getAllDepts.php?query=${element}`, (DeptNamedata, status) => {
                ...
                // $.get(`Controller\\permissionsRelated\\getAllDepts.php`, (dataxyz, status) => {
                //     console.log("This status of API :", status);
                //     console.log("12233");
                //     console.log("Data data", dataxyz);
                //     // data = JSON.parse(data);
                //     console.log("Desigantion Data :", data)
